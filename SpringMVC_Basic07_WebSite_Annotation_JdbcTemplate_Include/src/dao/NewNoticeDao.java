...
@Repository //전제조건 : 자동으로 dao객체를 생성(xml에서 x)
public class NewNoticeDao implements NoticeDao {
	
	//jdbc Template객체에 의존한다.
	...
	public Notice getNotice(String seq) throws ClassNotFoundException, SQLException {
		...
		//아래와 같은 작업을 할거면 굳이 템플릿을 사용할 이유가 없다.
		//자동화에 준비를 하자. (ui의 input태그의 name속성값과 dto의 memberfield명과 db의 컬럼명을 똑같이 맞추자!!!)
